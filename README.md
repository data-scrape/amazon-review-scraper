...
[![GitHub stars](https://img.shields.io/github/stars/xiaozhucchongya-byte/amazon-review-scraper?style=social)](https://github.com/xiaozhucchongya-byte/amazon-review-scraper)
[![GitHub forks](https://img.shields.io/github/forks/xiaozhucchongya-byte/amazon-review-scraper?style=social)](https://github.com/xiaozhucchongya-byte/amazon-review-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/xiaozhucchongya-byte/amazon-review-scraper)](https://github.com/xiaozhucchongya-byte/amazon-review-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/xiaozhucchongya-byte/amazon-review-scraper)](https://github.com/xiaozhucchongya-byte/amazon-review-scraper/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Amazon review scraper - extract product reviews and ratings in bulk


<!-- SEO keywords: amazon review scraper, Amazon Review Scraper, amazon review scraper python, amazon review scraper github, best amazon review scraper -->
...
- Extract Amazon product reviews in bulk
- Get review text, ratings, dates, and reviewer info
- Filter reviews by star rating (1-5 stars)
- Sort by most helpful, most recent, or top reviews
- Extract verified purchase reviews
- Pagination support for thousands of reviews
- Reviewer profile data extraction
- Export to JSON, CSV, or Excel

## 🎯 Use Cases

Analyze product sentiment, monitor competitor reviews, extract customer feedback for product improvement, or build review datasets for NLP analysis.
...
```python
scrape_amazon_reviews("B08N5WRWNW")
# Extracts all reviews for an ASIN
# Returns: [{'review_id': '...', 'rating': 5, 'title': '...', 'body': '...'}, ...]
```
...
```bash
pip install git+https://github.com/xiaozhucchongya-byte/amazon-review-scraper.git
```

### From source

```bash
git clone https://github.com/xiaozhucchongya-byte/amazon-review-scraper.git
...
from amazon_review_scraper import Scraper
...
python -m amazon_review_scraper --query "your-query" --output results.json
```
...
### Is Amazon Review Scraper legal to use?
...
### Do I need to login to use amazon review scraper?
...
### Will I get banned for using amazon review scraper?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/xiaozhucchongya-byte/amazon-review-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/xiaozhucchongya-byte/amazon-review-scraper/issues) if you find a bug
...
[![Star History](https://img.shields.io/github/stars/xiaozhucchongya-byte/amazon-review-scraper?style=social)](https://github.com/xiaozhucchongya-byte/amazon-review-scraper)
